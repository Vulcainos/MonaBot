...
client.on('interactionCreate', async interaction => {
            ...
            getWeatherDataFrom(cityInfo.codesPostaux[0]).then(weather => {
                ...
                getForecastDataFrom(cityInfo.codesPostaux[0]).then(forecast => {
                    ...
                    .then(photoURL => {
                        ...
                        .addFields(
                            { name: `Météo actuelle dans le ${zipcode_depart}`, value : `:thermometer: ${weather.temp}°C ressenti ${weather.feels_temp} °C\r\n`},
                            { name: `\u200b`, value : `Le temps est **${weather.desc}** ${emojiState}\r\n`, inline: true},
                        ...
                        .addFields(
                            ...
                            { name: `\u200b`, value : `Le temps sera **${forecast.desc}** ${emojiStateForecast}`, inline: true},
    ...
    } else if(commandName === 'testjournal') {
        getArticles();
        subscribedUsers.users.forEach((user) => {
           sendJournalTo(user);
